Module MyMod
    ...
    Public users_api As String = "http://f0833875.xsph.ru/" & api_folder & "/users_api.php"
    Public kamar_api As String = "http://f0833875.xsph.ru/" & api_folder & "/kamar_api.php"
    Public penyewa_api As String = "http://f0833875.xsph.ru/" & api_folder & "/penyewa_api.php"
    Public user_api As String = "http://f0833875.xsph.ru/" & api_folder & "/user_api.php"
